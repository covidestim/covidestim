...
// }
    ...
    if (susceptible_prvl[i] < 1) {      susceptible_prvl[i] = 1;}
...
generated quantities {
  ...
  vector[N_weeks_tot-N_weeks_before]  infections_cumulative;  
...
// }
  ...
  infections_cumulative[1:] = cumulative_sum(infections[N_weeks_before+1:]) ; 
