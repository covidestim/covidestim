...
#include "stanExports_stan_program_default.h"

RCPP_MODULE(stan_fit4stan_program_default_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_stan_program_default")
