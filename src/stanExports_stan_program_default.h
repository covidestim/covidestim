...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(425, 423, "end", "model_stan_program_default");
    return reader;
}
...
private:
        ...
        double pri_cas_rep_delay_shap_a;
        double pri_cas_rep_delay_shap_b;
        double pri_cas_rep_delay_rate_a;
        double pri_cas_rep_delay_rate_b;
        double pri_die_rep_delay_shap_a;
        double pri_die_rep_delay_shap_b;
        double pri_die_rep_delay_rate_a;
        double pri_die_rep_delay_rate_b;
        double pri_inv_sqrt_phi;
        int cas_yes;
        int die_yes;
        int obs_cas_rep;
        int obs_die_rep;
        ...
        vector_d inf_cum_prg_delay;
        vector_d sym_cum_prg_delay;
        vector_d sev_cum_prg_delay;
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            check_greater_or_equal(function__, "N_spl_par", N_spl_par, 0);
            ...
            context__.validate_dims("data initialization", "pri_cas_rep_delay_shap_a", "double", context__.to_vec());
            pri_cas_rep_delay_shap_a = double(0);
            vals_r__ = context__.vals_r("pri_cas_rep_delay_shap_a");
            pos__ = 0;
            pri_cas_rep_delay_shap_a = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_cas_rep_delay_shap_a", pri_cas_rep_delay_shap_a, 0);
            current_statement_begin__ = 57;
            context__.validate_dims("data initialization", "pri_cas_rep_delay_shap_b", "double", context__.to_vec());
            pri_cas_rep_delay_shap_b = double(0);
            vals_r__ = context__.vals_r("pri_cas_rep_delay_shap_b");
            pos__ = 0;
            pri_cas_rep_delay_shap_b = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_cas_rep_delay_shap_b", pri_cas_rep_delay_shap_b, 0);
            current_statement_begin__ = 58;
            context__.validate_dims("data initialization", "pri_cas_rep_delay_rate_a", "double", context__.to_vec());
            pri_cas_rep_delay_rate_a = double(0);
            vals_r__ = context__.vals_r("pri_cas_rep_delay_rate_a");
            pos__ = 0;
            pri_cas_rep_delay_rate_a = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_cas_rep_delay_rate_a", pri_cas_rep_delay_rate_a, 0);
            current_statement_begin__ = 59;
            context__.validate_dims("data initialization", "pri_cas_rep_delay_rate_b", "double", context__.to_vec());
            pri_cas_rep_delay_rate_b = double(0);
            vals_r__ = context__.vals_r("pri_cas_rep_delay_rate_b");
            pos__ = 0;
            pri_cas_rep_delay_rate_b = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_cas_rep_delay_rate_b", pri_cas_rep_delay_rate_b, 0);
            current_statement_begin__ = 61;
            context__.validate_dims("data initialization", "pri_die_rep_delay_shap_a", "double", context__.to_vec());
            pri_die_rep_delay_shap_a = double(0);
            vals_r__ = context__.vals_r("pri_die_rep_delay_shap_a");
            pos__ = 0;
            pri_die_rep_delay_shap_a = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_die_rep_delay_shap_a", pri_die_rep_delay_shap_a, 0);
            current_statement_begin__ = 62;
            context__.validate_dims("data initialization", "pri_die_rep_delay_shap_b", "double", context__.to_vec());
            pri_die_rep_delay_shap_b = double(0);
            vals_r__ = context__.vals_r("pri_die_rep_delay_shap_b");
            pos__ = 0;
            pri_die_rep_delay_shap_b = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_die_rep_delay_shap_b", pri_die_rep_delay_shap_b, 0);
            current_statement_begin__ = 63;
            context__.validate_dims("data initialization", "pri_die_rep_delay_rate_a", "double", context__.to_vec());
            pri_die_rep_delay_rate_a = double(0);
            vals_r__ = context__.vals_r("pri_die_rep_delay_rate_a");
            pos__ = 0;
            pri_die_rep_delay_rate_a = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_die_rep_delay_rate_a", pri_die_rep_delay_rate_a, 0);
            current_statement_begin__ = 64;
            context__.validate_dims("data initialization", "pri_die_rep_delay_rate_b", "double", context__.to_vec());
            pri_die_rep_delay_rate_b = double(0);
            vals_r__ = context__.vals_r("pri_die_rep_delay_rate_b");
            pos__ = 0;
            pri_die_rep_delay_rate_b = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_die_rep_delay_rate_b", pri_die_rep_delay_rate_b, 0);
            current_statement_begin__ = 66;
            context__.validate_dims("data initialization", "pri_inv_sqrt_phi", "double", context__.to_vec());
            pri_inv_sqrt_phi = double(0);
            vals_r__ = context__.vals_r("pri_inv_sqrt_phi");
            pos__ = 0;
            pri_inv_sqrt_phi = vals_r__[pos__++];
            check_greater_or_equal(function__, "pri_inv_sqrt_phi", pri_inv_sqrt_phi, 0);
            ...
            context__.validate_dims("data initialization", "n_day_av", "int", context__.to_vec());
            n_day_av = int(0);
            vals_i__ = context__.vals_i("n_day_av");
            pos__ = 0;
            n_day_av = vals_i__[pos__++];
            check_greater_or_equal(function__, "n_day_av", n_day_av, 1);
            check_less_or_equal(function__, "n_day_av", n_day_av, 7);
            ...
            validate_non_negative_index("inf_cum_prg_delay", "Max_delay", Max_delay);
            inf_cum_prg_delay = Eigen::Matrix<double, Eigen::Dynamic, 1>(Max_delay);
            stan::math::fill(inf_cum_prg_delay, DUMMY_VAR__);
            current_statement_begin__ = 82;
            validate_non_negative_index("sym_cum_prg_delay", "Max_delay", Max_delay);
            sym_cum_prg_delay = Eigen::Matrix<double, Eigen::Dynamic, 1>(Max_delay);
            stan::math::fill(sym_cum_prg_delay, DUMMY_VAR__);
            current_statement_begin__ = 83;
            validate_non_negative_index("sev_cum_prg_delay", "Max_delay", Max_delay);
            sev_cum_prg_delay = Eigen::Matrix<double, Eigen::Dynamic, 1>(Max_delay);
            stan::math::fill(sev_cum_prg_delay, DUMMY_VAR__);
            // execute transformed data statements
            current_statement_begin__ = 85;
            stan::math::assign(N_days_tot, (N_days + N_days_before));
            current_statement_begin__ = 86;
            stan::math::assign(nda0, (n_day_av - 1));
            ...
            validate_non_negative_index("spl_par", "N_spl_par", N_spl_par);
            ...
            validate_non_negative_index("spl_par_dx", "N_spl_par_dx", N_spl_par_dx);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 109;
        if (!(context__.contains_r("spl_par")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable spl_par missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("spl_par");
        pos__ = 0U;
        validate_non_negative_index("spl_par", "N_spl_par", N_spl_par);
        context__.validate_dims("parameter initialization", "spl_par", "vector_d", context__.to_vec(N_spl_par));
        Eigen::Matrix<double, Eigen::Dynamic, 1> spl_par(N_spl_par);
        size_t spl_par_j_1_max__ = N_spl_par;
        for (size_t j_1__ = 0; j_1__ < spl_par_j_1_max__; ++j_1__) {
            spl_par(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(spl_par);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable spl_par: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 112;
        ...
        try {
            writer__.scalar_lb_unconstrain(0.05, cas_rep_delay_rate);
        } catch (const std::exception& e) {
        ...
        try {
            writer__.scalar_lb_unconstrain(0.05, die_rep_delay_rate);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 125;
        if (!(context__.contains_r("spl_par_dx")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable spl_par_dx missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("spl_par_dx");
        pos__ = 0U;
        validate_non_negative_index("spl_par_dx", "N_spl_par_dx", N_spl_par_dx);
        context__.validate_dims("parameter initialization", "spl_par_dx", "vector_d", context__.to_vec(N_spl_par_dx));
        Eigen::Matrix<double, Eigen::Dynamic, 1> spl_par_dx(N_spl_par_dx);
        size_t spl_par_dx_j_1_max__ = N_spl_par_dx;
        for (size_t j_1__ = 0; j_1__ < spl_par_dx_j_1_max__; ++j_1__) {
            spl_par_dx(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(spl_par_dx);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable spl_par_dx: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 128;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 109;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> spl_par;
            (void) spl_par;  // dummy to suppress unused var warning
            if (jacobian__)
                spl_par = in__.vector_constrain(N_spl_par, lp__);
            else
                spl_par = in__.vector_constrain(N_spl_par);
            current_statement_begin__ = 112;
            ...
            if (jacobian__)
                cas_rep_delay_rate = in__.scalar_lb_constrain(0.05, lp__);
            else
                cas_rep_delay_rate = in__.scalar_lb_constrain(0.05);
            current_statement_begin__ = 120;
            ...
            if (jacobian__)
                die_rep_delay_rate = in__.scalar_lb_constrain(0.05, lp__);
            else
                die_rep_delay_rate = in__.scalar_lb_constrain(0.05);
            current_statement_begin__ = 124;
            ...
            current_statement_begin__ = 125;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> spl_par_dx;
            (void) spl_par_dx;  // dummy to suppress unused var warning
            if (jacobian__)
                spl_par_dx = in__.vector_constrain(N_spl_par_dx, lp__);
            else
                spl_par_dx = in__.vector_constrain(N_spl_par_dx);
            current_statement_begin__ = 128;
            ...
            validate_non_negative_index("deriv1_spl_par", "(N_spl_par - 1)", (N_spl_par - 1));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> deriv1_spl_par((N_spl_par - 1));
            stan::math::initialize(deriv1_spl_par, DUMMY_VAR__);
            stan::math::fill(deriv1_spl_par, DUMMY_VAR__);
            current_statement_begin__ = 143;
            validate_non_negative_index("deriv2_spl_par", "(N_spl_par - 2)", (N_spl_par - 2));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> deriv2_spl_par((N_spl_par - 2));
            stan::math::initialize(deriv2_spl_par, DUMMY_VAR__);
            stan::math::fill(deriv2_spl_par, DUMMY_VAR__);
            ...
            validate_non_negative_index("p_diag_if_sym_t", "N_days_tot", N_days_tot);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> p_diag_if_sym_t(N_days_tot);
            stan::math::initialize(p_diag_if_sym_t, DUMMY_VAR__);
            stan::math::fill(p_diag_if_sym_t, DUMMY_VAR__);
            current_statement_begin__ = 147;
            validate_non_negative_index("rr_diag_sym_vs_sev_t", "N_days_tot", N_days_tot);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> rr_diag_sym_vs_sev_t(N_days_tot);
            stan::math::initialize(rr_diag_sym_vs_sev_t, DUMMY_VAR__);
            stan::math::fill(rr_diag_sym_vs_sev_t, DUMMY_VAR__);
            ...
            stan::math::assign(rr_diag_sym_vs_sev_t, inv_logit(multiply(spl_basis_dx, spl_par_dx)));
            current_statement_begin__ = 183;
            stan::math::assign(p_die_if_inf, ((p_sym_if_inf * p_sev_if_sym) * p_die_if_sev));
            current_statement_begin__ = 184;
            stan::math::assign(p_diag_if_sym_t, multiply(p_diag_if_sev, rr_diag_sym_vs_sev_t));
            ...
            for (int i = 1; i <= (N_spl_par - 2); ++i) {
                ...
                stan::model::assign(deriv2_spl_par, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (((get_base1(spl_par, (i + 1), "spl_par", 1) * 2) - get_base1(spl_par, i, "spl_par", 1)) - get_base1(spl_par, (i + 2), "spl_par", 1)), 
                            "assigning variable deriv2_spl_par");
            }
            current_statement_begin__ = 215;
            for (int i = 1; i <= (N_spl_par - 1); ++i) {
                current_statement_begin__ = 216;
                stan::model::assign(deriv1_spl_par, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(spl_par, (i + 1), "spl_par", 1) - get_base1(spl_par, i, "spl_par", 1)), 
                            "assigning variable deriv1_spl_par");
            }
            current_statement_begin__ = 221;
            stan::math::assign(logRt, multiply(spl_basis, spl_par));
                ...
                for (int j = 1; j <= Max_delay; ++j) {
                    ...
                    if (as_bool(logical_lte((i + (j - 1)), N_days_tot))) {
                        ...
                        stan::model::assign(new_sym_dx, 
                                    stan::model::cons_list(stan::model::index_uni((i + (j - 1))), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(new_sym_dx, stan::model::cons_list(stan::model::index_uni((i + (j - 1))), stan::model::nil_index_list()), "new_sym_dx") + ((get_base1(new_sym, i, "new_sym", 1) * get_base1(p_diag_if_sym_t, i, "p_diag_if_sym_t", 1)) * get_base1(sym_diag_delay, j, "sym_diag_delay", 1))), 
                ...
                for (int j = 1; j <= Max_delay; ++j) {
                    ...
                    if (as_bool(logical_lte((i + (j - 1)), N_days_tot))) {
                        ...
                        stan::model::assign(dx_sym_sev, 
                                    stan::model::cons_list(stan::model::index_uni((i + (j - 1))), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(dx_sym_sev, stan::model::cons_list(stan::model::index_uni((i + (j - 1))), stan::model::nil_index_list()), "dx_sym_sev") + (((get_base1(new_sym, i, "new_sym", 1) * get_base1(p_diag_if_sym_t, i, "p_diag_if_sym_t", 1)) * p_sev_if_sym) * get_base1(sym_prg_delay, j, "sym_prg_delay", 1))), 
                ...
                for (int j = 1; j <= Max_delay; ++j) {
                    ...
                    if (as_bool(logical_lte((i + (j - 1)), N_days_tot))) {
                        ...
                        stan::model::assign(new_sev_dx, 
                                    stan::model::cons_list(stan::model::index_uni((i + (j - 1))), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(new_sev_dx, stan::model::cons_list(stan::model::index_uni((i + (j - 1))), stan::model::nil_index_list()), "new_sev_dx") + (((get_base1(new_sev, i, "new_sev", 1) - get_base1(dx_sym_sev, i, "dx_sym_sev", 1)) * p_diag_if_sev) * get_base1(sev_diag_delay, j, "sev_diag_delay", 1))), 
            ...
            current_statement_begin__ = 142;
            size_t deriv1_spl_par_j_1_max__ = (N_spl_par - 1);
            for (size_t j_1__ = 0; j_1__ < deriv1_spl_par_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(deriv1_spl_par(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: deriv1_spl_par" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable deriv1_spl_par: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 143;
            size_t deriv2_spl_par_j_1_max__ = (N_spl_par - 2);
            for (size_t j_1__ = 0; j_1__ < deriv2_spl_par_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(deriv2_spl_par(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: deriv2_spl_par" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable deriv2_spl_par: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 145;
            ...
            current_statement_begin__ = 146;
            size_t p_diag_if_sym_t_j_1_max__ = N_days_tot;
            for (size_t j_1__ = 0; j_1__ < p_diag_if_sym_t_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(p_diag_if_sym_t(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: p_diag_if_sym_t" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable p_diag_if_sym_t: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 147;
            size_t rr_diag_sym_vs_sev_t_j_1_max__ = N_days_tot;
            for (size_t j_1__ = 0; j_1__ < rr_diag_sym_vs_sev_t_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(rr_diag_sym_vs_sev_t(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: rr_diag_sym_vs_sev_t" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable rr_diag_sym_vs_sev_t: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 150;
            ...
            lp_accum__.add(normal_log<propto__>(spl_par, pri_logRt_mu, pri_logRt_sd));
            current_statement_begin__ = 364;
            lp_accum__.add(lognormal_log<propto__>(serial_i, pri_serial_i_a, pri_serial_i_b));
            current_statement_begin__ = 365;
            lp_accum__.add(student_t_log<propto__>(deriv1_spl_par, 10, 0, pri_deriv1_spl_par_sd));
            current_statement_begin__ = 366;
            lp_accum__.add(student_t_log<propto__>(deriv2_spl_par, 10, 0, pri_deriv2_spl_par_sd));
            ...
            lp_accum__.add(lognormal_log<propto__>(cas_rep_delay_shap, pri_cas_rep_delay_shap_a, pri_cas_rep_delay_shap_b));
            current_statement_begin__ = 378;
            lp_accum__.add(lognormal_log<propto__>(cas_rep_delay_rate, pri_cas_rep_delay_rate_a, pri_cas_rep_delay_rate_b));
            current_statement_begin__ = 379;
            lp_accum__.add(lognormal_log<propto__>(die_rep_delay_shap, pri_die_rep_delay_shap_a, pri_die_rep_delay_shap_b));
            current_statement_begin__ = 380;
            lp_accum__.add(lognormal_log<propto__>(die_rep_delay_rate, pri_die_rep_delay_rate_a, pri_die_rep_delay_rate_b));
            current_statement_begin__ = 383;
            lp_accum__.add(beta_log<propto__>(inv_logit(spl_par_dx), pri_rr_diag_sym_vs_sev_a, pri_rr_diag_sym_vs_sev_b));
            ...
            lp_accum__.add(normal_log<propto__>(inv_sqrt_phi_c, 0, pri_inv_sqrt_phi));
            current_statement_begin__ = 386;
            lp_accum__.add(normal_log<propto__>(inv_sqrt_phi_d, 0, pri_inv_sqrt_phi));
            ...
            if (as_bool(logical_eq(cas_yes, 1))) {
                ...
                for (int i = 1; i <= N_days; ++i) {
                    ...
                    lp_accum__.add((neg_binomial_2_log(tmp_obs_cas, tmp_occur_cas, phi_cas) / n_day_av));
            ...
            if (as_bool(logical_eq(die_yes, 1))) {
                ...
                for (int i = 1; i <= N_days; ++i) {
                    ...
                    lp_accum__.add((neg_binomial_2_log(tmp_obs_die, tmp_occur_die, phi_die) / n_day_av));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("deriv1_spl_par");
        names__.push_back("deriv2_spl_par");
        names__.push_back("p_die_if_inf");
        names__.push_back("p_diag_if_sym_t");
        names__.push_back("rr_diag_sym_vs_sev_t");
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> spl_par = in__.vector_constrain(N_spl_par);
        size_t spl_par_j_1_max__ = N_spl_par;
        for (size_t j_1__ = 0; j_1__ < spl_par_j_1_max__; ++j_1__) {
            vars__.push_back(spl_par(j_1__));
        }
        ...
        double cas_rep_delay_rate = in__.scalar_lb_constrain(0.05);
        ...
        double die_rep_delay_rate = in__.scalar_lb_constrain(0.05);
        vars__.push_back(die_rep_delay_rate);
        double p_diag_if_sev = in__.scalar_lub_constrain(0, 1);
        vars__.push_back(p_diag_if_sev);
        Eigen::Matrix<double, Eigen::Dynamic, 1> spl_par_dx = in__.vector_constrain(N_spl_par_dx);
        size_t spl_par_dx_j_1_max__ = N_spl_par_dx;
        for (size_t j_1__ = 0; j_1__ < spl_par_dx_j_1_max__; ++j_1__) {
            vars__.push_back(spl_par_dx(j_1__));
        }
        ...
        try {
            ...
            current_statement_begin__ = 142;
            validate_non_negative_index("deriv1_spl_par", "(N_spl_par - 1)", (N_spl_par - 1));
            Eigen::Matrix<double, Eigen::Dynamic, 1> deriv1_spl_par((N_spl_par - 1));
            stan::math::initialize(deriv1_spl_par, DUMMY_VAR__);
            stan::math::fill(deriv1_spl_par, DUMMY_VAR__);
            current_statement_begin__ = 143;
            validate_non_negative_index("deriv2_spl_par", "(N_spl_par - 2)", (N_spl_par - 2));
            Eigen::Matrix<double, Eigen::Dynamic, 1> deriv2_spl_par((N_spl_par - 2));
            stan::math::initialize(deriv2_spl_par, DUMMY_VAR__);
            stan::math::fill(deriv2_spl_par, DUMMY_VAR__);
            current_statement_begin__ = 145;
            double p_die_if_inf;
            ...
            current_statement_begin__ = 146;
            validate_non_negative_index("p_diag_if_sym_t", "N_days_tot", N_days_tot);
            Eigen::Matrix<double, Eigen::Dynamic, 1> p_diag_if_sym_t(N_days_tot);
            stan::math::initialize(p_diag_if_sym_t, DUMMY_VAR__);
            stan::math::fill(p_diag_if_sym_t, DUMMY_VAR__);
            current_statement_begin__ = 147;
            validate_non_negative_index("rr_diag_sym_vs_sev_t", "N_days_tot", N_days_tot);
            Eigen::Matrix<double, Eigen::Dynamic, 1> rr_diag_sym_vs_sev_t(N_days_tot);
            stan::math::initialize(rr_diag_sym_vs_sev_t, DUMMY_VAR__);
            stan::math::fill(rr_diag_sym_vs_sev_t, DUMMY_VAR__);
            current_statement_begin__ = 150;
            validate_non_negative_index("sym_diag_delay", "Max_delay", Max_delay);
            ...
            if (include_tparams__) {
                ...
                size_t deriv1_spl_par_j_1_max__ = (N_spl_par - 1);
                for (size_t j_1__ = 0; j_1__ < deriv1_spl_par_j_1_max__; ++j_1__) {
                    vars__.push_back(deriv1_spl_par(j_1__));
                }
                size_t deriv2_spl_par_j_1_max__ = (N_spl_par - 2);
                for (size_t j_1__ = 0; j_1__ < deriv2_spl_par_j_1_max__; ++j_1__) {
                    vars__.push_back(deriv2_spl_par(j_1__));
                }
                vars__.push_back(p_die_if_inf);
                size_t p_diag_if_sym_t_j_1_max__ = N_days_tot;
                for (size_t j_1__ = 0; j_1__ < p_diag_if_sym_t_j_1_max__; ++j_1__) {
                    vars__.push_back(p_diag_if_sym_t(j_1__));
                }
                size_t rr_diag_sym_vs_sev_t_j_1_max__ = N_days_tot;
                for (size_t j_1__ = 0; j_1__ < rr_diag_sym_vs_sev_t_j_1_max__; ++j_1__) {
                    vars__.push_back(rr_diag_sym_vs_sev_t(j_1__));
                }
                size_t sym_diag_delay_j_1_max__ = Max_delay;
                for (size_t j_1__ = 0; j_1__ < sym_diag_delay_j_1_max__; ++j_1__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < spl_par_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "spl_par" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        ...
        for (size_t j_1__ = 0; j_1__ < spl_par_dx_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "spl_par_dx" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < deriv1_spl_par_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "deriv1_spl_par" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t deriv2_spl_par_j_1_max__ = (N_spl_par - 2);
            for (size_t j_1__ = 0; j_1__ < deriv2_spl_par_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "deriv2_spl_par" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            param_name_stream__.str(std::string());
            ...
            for (size_t j_1__ = 0; j_1__ < p_diag_if_sym_t_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "p_diag_if_sym_t" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t rr_diag_sym_vs_sev_t_j_1_max__ = N_days_tot;
            for (size_t j_1__ = 0; j_1__ < rr_diag_sym_vs_sev_t_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "rr_diag_sym_vs_sev_t" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t sym_diag_delay_j_1_max__ = Max_delay;
            for (size_t j_1__ = 0; j_1__ < sym_diag_delay_j_1_max__; ++j_1__) {
