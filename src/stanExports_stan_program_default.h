...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(648, 646, "end", "model_stan_program_default");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "predata_flat_rt", "int", context__.to_vec());
            predata_flat_rt = int(0);
            vals_i__ = context__.vals_i("predata_flat_rt");
            pos__ = 0;
            predata_flat_rt = vals_i__[pos__++];
            check_greater_or_equal(function__, "predata_flat_rt", predata_flat_rt, 0);
            check_less_or_equal(function__, "predata_flat_rt", predata_flat_rt, 1);
            ...
            validate_non_negative_index("spl_par_rt0", "(N_spl_par_rt - 1)", (N_spl_par_rt - 1));
            num_params_r__ += (N_spl_par_rt - 1);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 196;
        if (!(context__.contains_r("spl_par_rt0")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable spl_par_rt0 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("spl_par_rt0");
        pos__ = 0U;
        validate_non_negative_index("spl_par_rt0", "(N_spl_par_rt - 1)", (N_spl_par_rt - 1));
        context__.validate_dims("parameter initialization", "spl_par_rt0", "vector_d", context__.to_vec((N_spl_par_rt - 1)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> spl_par_rt0((N_spl_par_rt - 1));
        size_t spl_par_rt0_j_1_max__ = (N_spl_par_rt - 1);
        for (size_t j_1__ = 0; j_1__ < spl_par_rt0_j_1_max__; ++j_1__) {
            spl_par_rt0(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(spl_par_rt0);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable spl_par_rt0: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 197;
        if (!(context__.contains_r("spl_par_rt1")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable spl_par_rt1 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("spl_par_rt1");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "spl_par_rt1", "double", context__.to_vec());
        double spl_par_rt1(0);
        spl_par_rt1 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(spl_par_rt1);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable spl_par_rt1: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 201;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 196;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> spl_par_rt0;
            (void) spl_par_rt0;  // dummy to suppress unused var warning
            if (jacobian__)
                spl_par_rt0 = in__.vector_constrain((N_spl_par_rt - 1), lp__);
            else
                spl_par_rt0 = in__.vector_constrain((N_spl_par_rt - 1));
            current_statement_begin__ = 197;
            local_scalar_t__ spl_par_rt1;
            (void) spl_par_rt1;  // dummy to suppress unused var warning
            if (jacobian__)
                spl_par_rt1 = in__.scalar_constrain(lp__);
            else
                spl_par_rt1 = in__.scalar_constrain();
            current_statement_begin__ = 201;
            ...
            stan::math::assign(p_die_if_sevt, multiply(((p_die_if_sev / (1 - p_die_if_sev)) * ifr_adj_fixed), add(1.0, multiply(ifr_adj, ifr_decl_OR))));
            current_statement_begin__ = 283;
            stan::math::assign(p_die_if_sevt, elt_divide(p_die_if_sevt, add(1, p_die_if_sevt)));
            ...
            stan::model::assign(spl_par_rt, 
                        stan::model::cons_list(stan::model::index_min_max(2, N_spl_par_rt), stan::model::nil_index_list()), 
                        spl_par_rt0, 
                        "assigning variable spl_par_rt");
            current_statement_begin__ = 321;
            if (as_bool(logical_eq(predata_flat_rt, 1))) {
                current_statement_begin__ = 322;
                stan::model::assign(spl_par_rt, 
                            stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                            (multiply(subtract(stan::model::rvalue(spl_basis_rt, stan::model::cons_list(stan::model::index_uni((2 + N_days_before)), stan::model::cons_list(stan::model::index_min_max(2, N_spl_par_rt), stan::model::nil_index_list())), "spl_basis_rt"), stan::model::rvalue(spl_basis_rt, stan::model::cons_list(stan::model::index_uni((1 + N_days_before)), stan::model::cons_list(stan::model::index_min_max(2, N_spl_par_rt), stan::model::nil_index_list())), "spl_basis_rt")), spl_par_rt0) / (get_base1(spl_basis_rt, (1 + N_days_before), 1, "spl_basis_rt", 1) - get_base1(spl_basis_rt, (2 + N_days_before), 1, "spl_basis_rt", 1))), 
                            "assigning variable spl_par_rt");
            } else {
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("spl_par_rt0");
        names__.push_back("spl_par_rt1");
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> spl_par_rt0 = in__.vector_constrain((N_spl_par_rt - 1));
        size_t spl_par_rt0_j_1_max__ = (N_spl_par_rt - 1);
        for (size_t j_1__ = 0; j_1__ < spl_par_rt0_j_1_max__; ++j_1__) {
            vars__.push_back(spl_par_rt0(j_1__));
        }
        double spl_par_rt1 = in__.scalar_constrain();
        vars__.push_back(spl_par_rt1);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < spl_par_rt0_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "spl_par_rt0" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        param_name_stream__ << "spl_par_rt1";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
