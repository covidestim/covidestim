...
# 
#   d <- get_ifr('09009', startDate)
# 
#   expect_equal(min(d$date), startDate)
# 
#   expect_error(get_ifr('09009', invalidDates[1]))
#   expect_error(get_ifr('09009', invalidDates[2]))
# })
# 
...
#   result <- gen_ifr_adjustments(as.Date('2020-01-22'), N_days_before, 'New York')
# 
...
#     seq.Date(
#       as.Date('2020-01-22') - days(N_days_before) + days(14),
#       as.Date('2021-12-31'),
#       by = '1 day'
#     ) %>% length
#   )
